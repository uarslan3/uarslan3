...
public class MainUI extends UI {
    ...
    private void addForm() {
        ...
        CityAdding.setWidth("400");

        Button AddingButton = new Button("Zonguldak'ın hava durumu :");
        ...
        AddingButton.addClickListener(click ->{
            ...
            WeatherE weather = weatherService.getWeather("Turkey", "Zonguldak");
    ...
    private void addHeader() {
        Label header = new Label("Zonguldak");
